...
\begin{itemize}
\item Data: supernova.  $432^3$ floating point.
\item Threshold: 0.07 and above.
\item Resulting mesh: 3,245,512 cells, 4,090,196 points
\item Dual Quad-Core Intel Xeon processors (8 cores total), 32 GB system memory.
\item 1 NVIDA Quadro 4000, 2 GB memory.
\end{itemize}
